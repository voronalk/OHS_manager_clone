...
var moveTo = function moveTo(offset) {
  // const z = document.querySelector('[data-rbd-droppable-id=column-2]')
  // z ? console.log(z.style.width) : console.log("hello");
  // if (z) z.style = `width: 600px;`
...
var drop$1 = (function (_ref) {
  ...
  return function (next) {
    return function (action) {
      ...
      // setTimeout(() => {
      //   const z = document.querySelector('[data-rbd-droppable-id=column-2]')
      //   if (z) z.style = `width: ${state.dimensions.droppables['column-1'].page.borderBox.width}`
      //   console.log('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!');
      //   console.log(state);
      // }, 500)
